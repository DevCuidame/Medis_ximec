# 🚀 medisxime Project - Quick Start

El proyecto **medisxime** ha sido creado exitosamente con una arquitectura moderna, modular y escalable.
...
### 1. Abrir en VS Code
```bash
cd "c:\Users\julia\Dropbox\My PC (LAPTOP-LKGFJOOJ)\Downloads\medisxime"
code .
```
...
# DATABASE_URL=postgresql://usuario:contraseña@localhost:5432/medisxime_dev
```
...
pnpm -F @medisxime/frontend dev   # Solo frontend
pnpm -F @medisxime/backend dev    # Solo backend
...
# Base de datos
pnpm -F @medisxime/backend migrate # Corre migraciones
